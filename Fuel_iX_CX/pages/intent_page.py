...
class IntentPage:
    ...
    def scb_editing_callBack_booking_failed_node(self):
        ...
        intentlocators.SCB_TEXT_BLANK_TEXTBOX.fill('''Hmm, looks like that time slot is no longer available or you have already booked a time.''')
        ...
        intentlocators.SCB_TEXT_BLANK_TEXTBOX.fill('''Add Card,If you have recently booked a time we will be reaching out within an hour after your scheduled time.''')
